...
**Step 6: Power BI Reporting: Executive Sales Dashboard**

This stage involved the creation of a Power BI report titled 'Executive Sales Report', designed specifically for senior-level stakeholders.

This report provides a high-level overview of sales performance, product trends, and shipping duration efficiency.

The dataset if the report was sourced directly from the presentation table in the gold layer, ensuring that all business logic, date attributes, and enriched metrics are consistently applied.

**Tasks:**

        - Connection to the presentation table
        The Power Bi semantic model was built on top of the presentation table generated by Dataflow Gen2.
        This ensures:
        - consistent data
        - Data modelling: verfied relationships between product, customers and orders
        - Visual design and report layout: The executive sales report includes:
        - Sales trend across the year recorded in the dataset
        - Top performing products by sales value and quantity ordered
        - Order distribution across shipping-duration categories
        - Distribution of order amount across customer country
        - Dashboard interactivity: interactive features were added including: slicers(date range, source name)
 **Outcome:** 

The executive sales report deliver a clear, insightful and strategic overview of business performance.

It provides executive with:

         - Real-time visibility of sales trends
         - Customer and product insight
         - Fulfilment pperformance
